...
import noteRssImage from "../../../assets/projects/note-rss.webp"
...
export const projectsArray = (lang: keyof typeof ui) => {
  ...
  return [
    {
      title: projects.noteRss.title,
      description: projects.noteRss.description,
      thumbnail: noteRssImage,
      lang: ["JavaScript", "TypeScript"],
      framework: ["Next.js"],
      link: "https://nextjs-note-rss.vercel.app/",
      githubLink: "https://github.com/taroj1205/nextjs-note-rss-minytheminer",
    },
    {
